...
<table>
    <tr>
        ...
        <td class="td-pdg-lft"><?= $form->field($parent, 'sub_county', ['addon' => ['prepend' => ['content' => '<i class="fa fa-map-marker"></i>']]])->dropDownList(StaticMethods::modelsToArray(SubCounties::allSubcounties(), 'id', 'name', false), ['prompt' => '-- Select Subcounty --']) ?></td>
