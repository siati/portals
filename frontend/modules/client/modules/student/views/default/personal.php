        ...
        <div class="gnrl-frm-bdy fit-in-pn">
            ...
            <table>
                <tr>
                    ...
                    <td class="td-pdg-lft"><?= $form->field($applicant, 'sub_county', ['addon' => ['prepend' => ['content' => '<i class="fa fa-map-marker"></i>']]])->dropDownList(StaticMethods::modelsToArray(SubCounties::allSubcounties(), 'id', 'name', false), ['prompt' => '-- Select Subcounty --']) ?></td>
