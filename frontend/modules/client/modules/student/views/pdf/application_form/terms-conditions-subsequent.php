...
<div class="part-container<?= $part->new_page == ApplicationParts::new_page_yes ? ' page-break' : '' ?>">
    ...
    <?php if (!empty($part->intro)): ?>
        <span class="part-element-narration-sm"><strong>Certify as follows</strong></span>
    ...
    <span class="part-element-narration-sm"><strong>Terms and Conditions</strong></span>
