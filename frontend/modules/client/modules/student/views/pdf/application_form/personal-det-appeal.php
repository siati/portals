    ...
    <table class="part-table">
        <tbody>
            <tr>
                ...
                <td class="part-table-label td-pdg-lft-pdf">Loan Serial No. :</td>
            ...
            <tr>
                ...
                <td class="part-table-label td-pdg-lft-pdf">Institution Name :</td>
            ...
            <tr>
                ...
                <td class="part-table-label td-pdg-lft-pdf">Email Address :</td>
            ...
            <tr>
                ...
                <td class="part-table-label td-pdg-lft-pdf">Bursary Awarded :</td>
                <td class="part-table-data align-left">KShs. 0.00</td>
            </tr>
        </tbody>
    </table>
