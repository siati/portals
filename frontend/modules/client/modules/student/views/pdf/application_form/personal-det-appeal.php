...
<div class="part-container<?= $part->new_page == ApplicationParts::new_page_yes ? ' page-break' : '' ?>">
    ...
    <table class="part-table">
        <tbody>
            <tr>
                <td class="part-table-data align-left">Full Name</td>
                <td class="part-table-data align-left"><?= "$applicant->fname $applicant->mname $applicant->lname" ?></td>
                <td class="part-table-data align-left">Loan Serial No.</td>
                <td class="part-table-data align-left"><?= $application->serial_no ?></td>
            </tr>
            
            <tr>
                <td class="part-table-data align-left"><?= empty($user->id_no) ? 'Birth Cert. No.' : 'Nat. ID. No.' ?></td>
                <td class="part-table-data align-left"><?= empty($user->id_no) ? $user->birth_cert_no : $user->id_no ?></td>
                <td class="part-table-data align-left">Institution Name</td>
            ...
            <tr>
                <td class="part-table-data align-left">Loan Awarded</td>
                <td class="part-table-data align-left">KShs. 0.00</td>
                <td class="part-table-data align-left">Bursary Awarded</td>
                <td class="part-table-data align-left">KShs. 0.00</td>
            </tr>
        </tbody>
    </table>
