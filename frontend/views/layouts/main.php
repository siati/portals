                                    ...
                                    [
                                        ...
                                        'items' => [
                                            ...
                                            ['label' => '<span class="pull-right badge">3</span> Profile', 'icon' => 'user', 'items' => [
                                                    ...
                                                    ['label' => SideNav::linkHelper($route = '/client/student/default/spouse', 'post', ['ApplicantsSpouse[applicant]' => $user_id], 'Spouse Details'), 'url' => '#', 'active' => ($requested_route == substr($route, 1))],
                                                    ...
                                                    ['label' => SideNav::linkHelper($route = '/client/student/default/employment', 'post', ['ApplicantsEmployment[applicant]' => $user_id], 'Employment Details'), 'url' => '#', 'active' => ($requested_route == substr($route, 1))],
