                                    ...
                                    [
                                        ...
                                        'items' => [
                                            ...
                                            ['label' => '<span class="pull-right badge">3</span> Profile', 'icon' => 'user', 'items' => [
                                                    ['label' => SideNav::linkHelper($route = '/client/student/default/register', 'post', ['Applicants[id]' => $user_id, 'User[id]' => $user_id], 'Personal Details', 'sd-nav-prsnl'), 'url' => '#', 'active' => ($requested_route == substr($route, 1))],
                                                    ['label' => SideNav::linkHelper($route = '/client/student/default/residence', 'post', ['ApplicantsResidence[applicant]' => $user_id], 'Current Residence Details', 'sd-nav-rsdnc'), 'url' => '#', 'active' => ($requested_route == substr($route, 1))],
                                                    ['label' => SideNav::linkHelper($route = '/client/student/default/education', 'post', ['EducationBackground[applicant]' => $user_id], 'Education Background', 'sd-nav-edctn'), 'url' => '#', 'active' => ($requested_route == substr($route, 1))],
                                                    ['label' => SideNav::linkHelper($route = '/client/student/default/parents', 'post', ['Applicants[id]' => $user_id], 'Parents\' Details', 'sd-nav-prnts'), 'url' => '#', 'active' => ($requested_route == substr($route, 1))],
                                                    ['label' => SideNav::linkHelper($route = '/client/student/default/sponsors', 'post', ['ApplicantSponsors[applicant]' => $user_id], 'Sponsors\' Details', 'sd-nav-spnsrs'), 'url' => '#', 'active' => ($requested_route == substr($route, 1))],
                                                    ['label' => SideNav::linkHelper($route = '/client/student/default/expenses', 'post', ['applicant' => $user_id], 'Family Expenses', 'sd-nav-expns'), 'url' => '#', 'active' => ($requested_route == substr($route, 1))],
                                                    ['label' => SideNav::linkHelper($route = '/client/student/default/spouse', 'post', ['ApplicantsSpouse[applicant]' => $user_id], 'Spouse Details', 'sd-nav-sps'), 'url' => '#', 'active' => ($requested_route == substr($route, 1))],
                                                    ['label' => SideNav::linkHelper($route = '/client/student/default/guarantors', 'post', ['ApplicantsGuarantors[applicant]' => $user_id], 'Guarantors\' Details', 'sd-nav-grntrs'), 'url' => '#', 'active' => ($requested_route == substr($route, 1))],
                                                    ['label' => SideNav::linkHelper($route = '/client/student/default/institution', 'post', ['ApplicantsInstitution[applicant]' => $user_id], 'Institution Details', 'sd-nav-inst'), 'url' => '#', 'active' => ($requested_route == substr($route, 1))],
                                                    ['label' => SideNav::linkHelper($route = '/client/student/default/employment', 'post', ['ApplicantsEmployment[applicant]' => $user_id], 'Employment Details', 'sd-nav-eplymt'), 'url' => '#', 'active' => ($requested_route == substr($route, 1))],
