...
$profile_items[] = ['label' => SideNav::linkHelper($route = '/client/student/default/loans', 'post', ['Applications[applicant]' => $user_id], 'My Loans', 'sd-nav-my-lns'), 'url' => '#', 'active' => ($requested_route == substr($route, 1))];
