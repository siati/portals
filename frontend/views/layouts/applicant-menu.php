...
if ($requested_route == substr($route = '/client/student/default/guarantors', 1))
    $profile_items[] = ['label' => SideNav::linkHelper($route, 'post', ['ApplicantsGuarantors[applicant]' => $user_id], 'Guarantors\' Details', 'sd-nav-grntrs'), 'url' => '#', 'active' => true];
